...
#define AI_NETWORK_MODEL_SIGNATURE     "196bcfbd200ef6b66eb780304404035a"
...
#define AI_TOOLS_DATE_TIME   "Sat Mar 19 06:44:29 2022"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    nl_4_nl_output_array.data = AI_PTR(activations_map[0] + 128);
    nl_4_nl_output_array.data_start = AI_PTR(activations_map[0] + 128);
    dense_5_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_5_output_array.data_start = AI_PTR(activations_map[0] + 0);
    nl_5_nl_output_array.data = AI_PTR(activations_map[0] + 128);
    nl_5_nl_output_array.data_start = AI_PTR(activations_map[0] + 128);
    dense_6_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_6_output_array.data_start = AI_PTR(activations_map[0] + 0);
    nl_6_nl_output_array.data = AI_PTR(activations_map[0] + 64);
    nl_6_nl_output_array.data_start = AI_PTR(activations_map[0] + 64);
    dense_7_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_7_output_array.data_start = AI_PTR(activations_map[0] + 0);
    nl_7_nl_output_array.data = AI_PTR(activations_map[0] + 64);
    nl_7_nl_output_array.data_start = AI_PTR(activations_map[0] + 64);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    dense_5_bias_array.data = AI_PTR(weights_map[0] + 37248);
    dense_5_bias_array.data_start = AI_PTR(weights_map[0] + 37248);
    dense_6_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_6_weights_array.data = AI_PTR(weights_map[0] + 37376);
    dense_6_weights_array.data_start = AI_PTR(weights_map[0] + 37376);
    dense_6_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_6_bias_array.data = AI_PTR(weights_map[0] + 39424);
    dense_6_bias_array.data_start = AI_PTR(weights_map[0] + 39424);
    dense_7_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_7_weights_array.data = AI_PTR(weights_map[0] + 39488);
    dense_7_weights_array.data_start = AI_PTR(weights_map[0] + 39488);
    dense_7_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_7_bias_array.data = AI_PTR(weights_map[0] + 40512);
    dense_7_bias_array.data_start = AI_PTR(weights_map[0] + 40512);
    dense_8_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_8_weights_array.data = AI_PTR(weights_map[0] + 40576);
    dense_8_weights_array.data_start = AI_PTR(weights_map[0] + 40576);
    dense_8_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_8_bias_array.data = AI_PTR(weights_map[0] + 40768);
    dense_8_bias_array.data_start = AI_PTR(weights_map[0] + 40768);
    return true;
  }
