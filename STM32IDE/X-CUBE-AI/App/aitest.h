...
/******************************************************************************/
#define AI_AITEST_IN_NUM        (1)

AI_DEPRECATED
#define AI_AITEST_IN \
  ai_aitest_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AITEST_IN_SIZE { \
  AI_AITEST_IN_1_SIZE, \
}
#define AI_AITEST_IN_SIZE_BYTES { \
  AI_AITEST_IN_1_SIZE_BYTES, \
}
#define AI_AITEST_IN_1_CHANNEL     (128)
#define AI_AITEST_IN_1_SIZE        (128)
#define AI_AITEST_IN_1_SIZE_BYTES  (512)

/******************************************************************************/
#define AI_AITEST_OUT_NUM       (1)

AI_DEPRECATED
#define AI_AITEST_OUT \
  ai_aitest_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AITEST_OUT_SIZE { \
  AI_AITEST_OUT_1_SIZE, \
}
#define AI_AITEST_OUT_SIZE_BYTES { \
  AI_AITEST_OUT_1_SIZE_BYTES, \
}
#define AI_AITEST_OUT_1_CHANNEL     (3)
#define AI_AITEST_OUT_1_SIZE        (3)
 ...
 * @ref ai_aitest_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_aitest_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_aitest_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_AITEST_*
 * defines into file @ref aitest.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
